 ...
 */
public class MultiWalletFiles implements WalletFilesInterface{
    private static final Logger log = LoggerFactory.getLogger(MultiWalletFiles.class);

    private final MultiWallet wallet;
     ...
     * saved automatically. The {@link MultiWallet} calls {@link #saveNow()} or {@link #saveLater()} as wallet state changes,
     * depending on the urgency of the changes.
     */
    public MultiWalletFiles(final MultiWallet wallet, File file, long delay, TimeUnit delayTimeUnit) {
