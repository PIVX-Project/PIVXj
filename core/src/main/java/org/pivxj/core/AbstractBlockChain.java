 ...
 * the lightweight SPV mode, a {@link org.pivxj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.pivxj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
